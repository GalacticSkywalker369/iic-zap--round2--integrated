...
const indianLanguages = [
  ...
  { code: "ks", name: "कश्मीરी (Kashmiri)" },
  { code: "sd", name: "سنڌي (Sindhi)" },
  { code: "doi", name: "डोगરी (Dogri)" },
...
const translations = {
  en: {
    title: "FarmAssist",
    loginTitle: "Sign Up For Your Account",
    username: "Username",
  ...
  hi: {
    ...
    dontHaveAccount: "पहले से खाता है?",
    signUpHere: "यहाँ लॉगिन करें",
...
export default function SignUpPage() {
  ...
  const handleSignUp = () => {
    console.log("[v0] Sign up attempt with:", { username, password, usernameCaptcha })
    window.location.href = "/dashboard"
  }

  const handleMobileSignUp = () => {
    console.log("[v0] Mobile sign up attempt with:", { mobile, otp, mobileCaptcha })
    window.location.href = "/dashboard"
  }
